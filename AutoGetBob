...
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "[ RobScripter ]",Text = "📢 [ You have not issued Bob, and not badge bob ] 🇻🇳.",Icon = "rbxassetid://7733658504",Duration = 10})
...
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "[ RobScripter ]",Text = "📢 [ You Got Badge Bob, Meaning you already have Bob ] 🇻🇳.",Icon = "rbxassetid://7733658504",Duration = 10})
end
end
