...
-- ✅ Vérifie si le joueur a le badge
...
-- ⚡ Spam le RemoteEvent sans freeze
...
local function serverHop()
	...
	while true do
		...
		if success then
			...
			warn("Erreur HTTP pour récupérer les serveurs.")
			break
		end
	end
...
task.spawn(function()
	pcall(function()
		...
		if hasBadge() then
			print("✅ Badge obtenu, script terminé.")
		else
			print("🔁 Badge pas obtenu, changement de serveur...")
			serverHop()
		end
	end)
end)
